...
//                cout << "Default last type = " << lastType << endl;
//                cout << "Default topOp = " << topOp << endl;
...
template <class NumericType>
void Evaluator<NumericType>::assignmentOp( TokenType ) {        /// Implement this.
...
void Evaluator<NumericType>::unaryOp(TokenType topOp) {
    ...
    if(topOp == UN_MINUS){
//        cout << "pre un minus PostFix stack = ";
//        printVector(postFixStack);
        postFixStack.push_back( var * -1 );
//        cout << "after un minus PostFix stack = ";
//        printVector(postFixStack);
